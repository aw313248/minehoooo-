...
const kinoBlocks: Block[] = [
  ...
  },
  {
    ...
    content: (
      <>
        <strong>有讀者問：Apple Log 到底是什麼？</strong><br />
        把它想成「數位底片的原始檔」。<br />
        一般錄影是拍完就把顏色「煮熟」給你——亮的爆掉、暗的死黑，都救不回來。<br />
        Apple Log 把感光元件收到的資訊盡量原封不動記下來：<br />
        畫面又灰又平，但亮部暗部的細節都還在，後期調色的空間完全不一樣。<br />
        代價只有一個：拍完一定要調色（或像我一樣開「即時 LUT」邊拍邊套），不然成品就是灰的
      </>
    ),
  },
