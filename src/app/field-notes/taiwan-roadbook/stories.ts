...
export const spotStories: SpotStory[] = [
  ...
  {
    match: "池上飯包",
    crowd: "87 年歷史的池上便當本家，坐進退役藍皮火車廂吃鐵路便當是招牌行程",
    why: "騎進池上第一件事：木盒飯包配一節老車廂，把午餐吃成時代劇",
    special: "木盒會吸走多餘水氣讓飯保持香Q；二樓故事館重現當年月台叫賣飯包的場景",
    srcLabel: "台東觀光旅遊網",
    srcUrl: "https://tour.taitung.gov.tw/zh-tw/attraction/details/487",
  },
  {
    match: "伯朗大道",
    crowd: "2.2 公里沒有一根電線桿的天堂之路，公認全台最超現實的稻田直線",
    why: "機車不能進——租台腳踏車慢慢晃，這段是整趟環島唯一的「換車」時刻",
    special: "金城武樹被颱風吹倒又復活，樹下人潮太多的話，隔壁蔡依林樹比較清靜",
    srcLabel: "花東縱谷國家風景區",
    srcUrl: "https://www.erv-nsa.gov.tw/zh-tw/attractions/detail/197",
  },
  {
    match: "鹿野高台",
    crowd: "2026 熱氣球嘉年華正好進行中（7/4–8/20），追球族一年回來一次的地方",
    why: "撞上嘉年華期間路過不上去說不過去——看球免費，傍晚 17:00 有繫留場",
    special: "高台可以俯瞰整個卑南溪谷；今年吉伊卡哇聯名球出沒，光雕音樂會在晚上",
    srcLabel: "臺灣國際熱氣球嘉年華",
    srcUrl: "https://balloontaiwan.taitung.gov.tw/zh-tw",
  },
  {
    match: "河樂廣場",
