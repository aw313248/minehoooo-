...
export const crimeShots: CrimeShot[] = [
  {
    id: "00",
    title: "城市建立鏡頭",
    storyFunction: "開場 — 九龍城寨式的天際線，先交代這是什麼世界",
  ...
  },
  {
    ...
    fix: "裁切 Raw 到約 5 秒，並給 Start／End 圖",
  },
  {
    id: "02",
    title: "狹窄走廊前進",
    storyFunction: "提著箱子朝鏡頭走來",
    generationMethod: "raw-driven",
    hasRawFootage: true,
    ...
    whatWorked: ["位移方向與速度都跟著 Raw 走", "走廊透視穩定沒有變形"],
  ...
  },
  {
    ...
    whatWorked: ["8.6 秒的動作用 9 秒生成 — 開箱到抽紙都完整", "開箱前後是同一只箱子"],
...
export const crimeMistakes = [
  { q: "01 原影片與生成秒數差太多", a: "12.6 秒的走位壓成 5 秒，模型就跳過走路、直接從門口開始。修正：裁切 Raw、讓輸入輸出長度接近，並給 Start／End 圖（本次實測建議，非官方規定）" },
