...
export const worksData: WorkEntry[] = [
  ...
  },
  {
    ...
    duration: "PT4M26S",
    metaDescription: "台中在地影像工作者 MINEH4O 執導的公益短片《孩子們需要超人》。大家願意一起披上披風——孩子們需要的，不只是奇蹟，是願意出現的人。2026 年 4 月。",
    keywords: ["孩子們需要超人", "公益短片", "MINEH4O", "在地影像工作者", "台灣短片", "兒童公益"],
    description: [
      "大家願意....一起披上披風嗎？",
      "孩子們需要的，不是奇蹟——是願意出現的人。在地影像工作者 MINEH4O 執導的公益短片，用影像說出一個關於陪伴與勇氣的故事。",
      "導演、剪輯均由在地影像工作者 MINEH4O（賴明宏）執行。",
    ],
    relatedSlugs: ["tedxnthu-2025", "cpbl-all-star-taiwolf-2025"],
