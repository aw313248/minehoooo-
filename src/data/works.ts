...
export const worksData: WorkEntry[] = [
  ...
  },
  {
    ...
    duration: "PT5M00S",
    metaDescription: "台中在地影像工作者 MINEH4O 擔任 Taiwolf 2025 中華職棒明星賽紀實影片《精銳》剪接，把台灣職棒精英球員的幕後與賽場瞬間剪成一支紀實。CPBL 紀錄片，2025 年。",
    keywords: ["中華職棒明星賽", "Taiwolf", "明星賽紀實", "逐夢之路", "CPBL All-Star", "職棒紀錄片", "MINEH4O", "在地影像工作者", "台灣棒球"],
    description: [
      "2025 中華職棒明星賽，不只是一場比賽，是整個球季最精銳的人聚在一起的一天。",
      "在地影像工作者 MINEH4O 受 Taiwolf 委託，擔任本次紀實影片剪接——把球員在鏡頭外的準備與等待，剪成看得見重量的五分鐘。",
      "剪接由在地影像工作者 MINEH4O（賴明宏）執行。",
    ],
    relatedSlugs: ["tedxnthu-2025"],
  },
  {
    slug: "66-central-deep-love",
    youtubeId: "xNg4Vupy8_0",
    title: "66《中部第一深情》",
    titleEn: "66 中部第一深情 MV",
    artist: "66 · 中部管轄區",
    role: "LIGHTING",
    category: "MUSIC VIDEO",
    uploadDate: "2024-01-01",
    duration: "PT3M30S",
    metaDescription: "66《中部第一深情》官方 MV 燈光，由台中在地影像工作者 MINEH4O（賴明宏）擔任燈光師。中部管轄區、中部饒舌 MV。",
    keywords: ["66 MV", "66 中部第一深情", "中部第一深情 MV", "中部管轄區", "MINEH4O", "在地影像工作者", "MV 燈光師", "台灣饒舌 MV", "中部 rapper"],
    description: [
      "《中部第一深情》是 66 的代表作之一，影像需要的不是炫技，而是把饒舌的情緒撐起來。",
      "燈光由在地影像工作者 MINEH4O（賴明宏）執行。",
    ],
    relatedSlugs: ["say-it", "dalow-badass-dance"],
  },
  {
  ...
  },
  {
    ...
    youtubeId: "w7QdrphExQ8",
    igReelId: "DXZZ6Gbkv_Y",
    thumbColor: "#0c100a",
    title: "《AIGC｜地瓜球也能打乒乓？》",
    titleEn: "AIGC — Taiwanese Sweet Ball Plays Ping Pong",
    artist: "MINEH4O",
    role: "DIR · AIGC",
    category: "AIGC",
    ...
    description: [
      ...
      "在地影像工作者 MINEH4O 用生成式 AI 讓台灣人的童年零食地瓜球動了起來，15 秒，一個荒謬又可愛的 AIGC 實驗。",
      "導演、AIGC 影像均由在地影像工作者 MINEH4O（賴明宏）執行。",
    ],
  ...
  },
  {
    ...
    youtubeId: "raIh2Qlj5YY",
    title: "《孩子們需要超人》",
    titleEn: "Children Need Superheroes — Short Film",
    artist: "MINEH4O",
    role: "DIR · EDIT",
    category: "SHORT FILM",
    uploadDate: "2026-04-09",
    duration: "PT4M26S",
    metaDescription: "在地影像工作者 MINEH4O 對台灣政府現況的直接表態——不是公益，是真的不爽。台中在地社會議題短片，2026 年 4 月。",
    keywords: ["孩子們需要超人", "社會議題短片", "MINEH4O", "在地影像工作者", "台灣短片", "台灣社會議題"],
    description: [
      "不是在拍公益廣告，是真的不爽政府。",
      "孩子們需要超人——但超人不該是奇蹟，是應該存在的制度和人。在地影像工作者 MINEH4O 用影像說他想說的話。",
      "導演、剪輯均由在地影像工作者 MINEH4O（賴明宏）執行。",
    ],
  ...
  },
  {
    ...
    youtubeId: "569NoV2tyUE",
    title: "Lil RAD & Coy6oi《早知道一個人也過得很好》ft.斑恩Ben",
    titleEn: "Lil RAD Coy6oi 早知道一個人也過得很好 ft.斑恩Ben MV",
    artist: "Lil RAD & Coy6oi",
    role: "DP",
    category: "MUSIC VIDEO",
  ...
  },
  {
    ...
    description: [
      "《爬坡 Her Slope》入選 2025 第62屆金馬影展（台北金馬影展 TGHFF），是台灣最具代表性的影展之一。",
